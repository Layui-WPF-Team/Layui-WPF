...
namespace LayuiTemplate.Dialog.Interface
{
    public interface ILayDialog
    {
        ...
        /// <param name="dialogName">窗体名称</param>
        /// <param name="parameters">参数</param>
        void ShowDialog(string dialogName, ILayDialogParameter parameters);
        /// <summary>
        /// 模态对话框
        /// </summary>
        /// <param name="dialogName">窗体名称</param>
        /// <param name="parameters">参数</param>
        /// <param name="callback">回调</param>
        void ShowDialog(string dialogName, ILayDialogParameter parameters, Action<ILayDialogResult> callback);
    }
}
