...
namespace LayUI.Wpf.Extend
{
    ...
    public class LayTextBoxHelper
    {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static LayUI.Wpf.Enum.InputType GetInputType(DependencyObject obj)
        {
            return (LayUI.Wpf.Enum.InputType)obj.GetValue(InputTypeProperty);
        }
        /// <summary>
        /// 设置输入类型
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="value"></param>
        public static void SetInputType(DependencyObject obj, LayUI.Wpf.Enum.InputType value)
        {
        ...
        public static readonly DependencyProperty InputTypeProperty =
            DependencyProperty.RegisterAttached("InputType", typeof(LayUI.Wpf.Enum.InputType), typeof(LayTextBoxHelper), new PropertyMetadata(OnIsInputTypeChanged));
