...
namespace LayUI.Wpf.Controls
{
    ...
    public class LayWindow : Window
    {
        ...
        private void OnHeaderHeightChanged(double headerHeight)
        {
            var windowChrome = WindowChrome.GetWindowChrome(this);
            if (windowChrome == null) windowChrome = CreateWindowChrome(headerHeight);
            else windowChrome.CaptionHeight = headerHeight;
            WindowChrome.SetWindowChrome(this, windowChrome);
        }  
        WindowChrome CreateWindowChrome(double headerHeight)
        {
