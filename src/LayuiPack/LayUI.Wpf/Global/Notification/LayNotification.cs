...
namespace LayUI.Wpf.Global
{
    ...
    public class LayNotification
    {
        ...
        public static void Default(string title,object Notification, string tooken = null, double time = 3) => Show(title,Notification, NotificationType.Default, tooken, time);
        /// <summary>
        /// 详细信息提示
        /// </summary>
        /// <param name="Notification">提示信息</param>
        /// <param name="tooken">自定义指定提示窗口</param>
        /// <param name="time">停留时间</param>
        public static void Info(string title, object Notification, string tooken = null, double time = 3) => Show(title, Notification, NotificationType.Info, tooken, time);
        ...
        /// <param name="tooken">自定义指定提示窗口</param>
        /// <param name="time">停留时间</param>
        public static void Success(string title, object Notification, string tooken = null, double time = 3) => Show(title, Notification, NotificationType.Success, tooken, time);
        /// <summary>
        /// 警告信息提示
        /// </summary>
        /// <param name="Notification">提示信息</param>
        /// <param name="tooken">自定义指定提示窗口</param>
        /// <param name="time">停留时间</param>
        public static void Warning(string title, object Notification, string tooken = null, double time = 3) => Show(title, Notification, NotificationType.Warning, tooken, time);
        /// <summary>
        /// 错误信息提示
        /// </summary>
        /// <param name="Notification">提示信息</param>
        /// <param name="tooken">自定义指定提示窗口</param>
        /// <param name="time">停留时间</param>
        public static void Error(string title, object Notification, string tooken = null, double time = 3) => Show(title, Notification, NotificationType.Error, tooken, time);
        /// <summary>
        /// 显示提示信息
        /// </summary>
        /// <param name="Notification">提示信息</param>
        ...
        /// <param name="tooken">自定义指定提示窗口</param>
        /// <param name="time">停留时间</param>
        private static void Show(string title, object Notification, NotificationType type, string tooken, double time)
        {
            if (tooken == null)
            {
                ...
                {
                    var page = new LayNotificationControl() { Title = title, Type = type, Content = Notification, Uid = Guid.NewGuid().ToString() };
                    Action close = () =>
                    {
                        page.Close = null;
